...
object Inst04LDARP extends FlatSpec with ChiselScalatestTester with TestUtil {
  def apply(implicit dut: CpuTestTb) {
    ...
    // ld h, $03                   ; h  = $02
    compareReg(0x02, 0x10, 0x20, 0x20, 0x10, 0x02, 0x00, 0x00, 0x010f, false, false, false, false) // m3 / m1
    dut.clock.step(1)
    ...
    compareReg(0x03, 0x10, 0x20, 0x20, 0x10, 0x02, 0xff, 0x00, 0x0114, false, false, false, false) // m3 / m1
    dut.clock.step(1)
