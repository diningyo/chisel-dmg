...
object Inst04LDARP extends FlatSpec with ChiselScalatestTester with TestUtil {
  def apply(implicit dut: CpuTestTb) {
    ...
    // ld d, $20                   ; d  = $20
    compareReg(0x00, 0x10, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0105, false, false, false, false) // m1
    dut.clock.step(1)
    compareReg(0x01, 0x10, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0106, false, false, false, false) // m2
    dut.clock.step(1)

	  // ld e, $10                   ; e  = $10
    compareReg(0x01, 0x10, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0107, false, false, false, false) // m1
    dut.clock.step(1)
    ...
    // ld h, $01                   ; h  = $01
    compareReg(0x01, 0x10, 0x20, 0x20, 0x10, 0x00, 0x00, 0x00, 0x010a, false, false, false, false) // m1
    dut.clock.step(1)
    ...
    dut.clock.step(1)
	  ...
	  // ld l, $ff                   ; l  = $ff
    //            a     b     c     d     e     h     l    sp      pc    f_z    f_n    f_h    f_c
    compareReg(0x02, 0x10, 0x20, 0x20, 0x10, 0x00, 0x00, 0x00, 0x010c, false, false, false, false) // m1
    dut.clock.step(1)
    ...
    dut.clock.step(1)
    compareReg(0x02, 0x10, 0x20, 0x20, 0x10, 0x01, 0xff, 0x00, 0x010f, false, false, false, false) // m2 / read $1020
    dut.clock.step(1)

    // ld h, $03                   ; d  = $02
    compareReg(0x02, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x010f, false, false, false, false) // m1
    dut.clock.step(1)
    compareReg(0x03, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0110, false, false, false, false) // m2
    dut.clock.step(1)

    // ld c, $20                   ; c  = $20
    compareReg(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0100, false, false, false, false) // m1
    dut.clock.step(1)
    compareReg(0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0101, false, false, false, false) // m2
    dut.clock.step(1)
