...
object Inst15CPAR extends FlatSpec with ChiselScalatestTester with TestUtil {
  def apply(implicit dut: CpuTestTb) {
    ...
    // or a, e                    ; a  = $07 & $08 = $0f
    compareReg(0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x0161, false, true,  false, false) // m1
    ...
    compareReg(0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x0166, false, true,  false, true) // m2

    // ld  b, $00
    compareReg(0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x0167, false, true,  false, false) // m1
    compareReg(0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x0168, false, true,  false, false) // m2
    compareReg(0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x0169, false, true,  false, false) // m1

    // or a, b                   ; a = $00 - $00 = $00 / z = 1
    compareReg(0x00, 0x00, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x016a, false, true,  false, false) // m1
