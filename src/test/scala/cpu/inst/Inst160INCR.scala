...
object Inst160INCR extends FlatSpec with ChiselScalatestTester with TestUtil {
  def apply(implicit dut: CpuTestTb) {
    ...
    // inc a                    ; a = $00 / z = 0 / h = 0 / c = 0
    compareReg(0xff, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x0168, false, false, false, false) // m2

    // ld  a, $0f
    compareReg(0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x0169, false, false, false, false) // m1
    compareReg(0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x016a, false, false, false, false) // m2

    // inc a                    ; a = $10 / z = 0 / h = 0 / c = 0
    compareReg(0x0f, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x016b, false, false, false, false) // m1
    compareReg(0x10, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x016c, false, false, false, false) // m1 - nop
  }
}
